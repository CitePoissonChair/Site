...
const photosImages = [
  { src: 'public/prestationscontenu/Cisnienie (1).jpg', alt: 'Photos 1', label: 'Photos', link: '/photos' },
  { src: 'public/prestationscontenu/Madame loyal (5).jpg', alt: 'Photos 2', link: '/photos' },
  { src: 'public/prestationscontenu/Youth Code (1).jpg', alt: 'Photos 3', link: '/photos' },
];
